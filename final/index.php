...
if($_SESSION['type']==1 and $_SESSION['complaint']=='draining')
header("Location: draining.php");
if($_SESSION['type']==1 and $_SESSION['complaint']=='carpentry')
header("Location: carpentry.php");
if($_SESSION['type']==1 and $_SESSION['complaint']=='masonry')
header("Location: masonry.php");
if($_SESSION['type']==1 and $_SESSION['complaint']=='plumbing')
...
<!--type of complaint-->
<center><span style="font-weight : bold"> X Complaints</span></center><br>
...
<td>&nbsp;</td><td align="left">
<input type="checkbox" name="p4" value="8" />Cleaning of Garbage.</td>
</tr>
<tr>
<td>&nbsp;</td>
...
<input type="checkbox" name="p5" value="16" />Cleaning of Toilets.</td>
</tr>
<tr>
<td></td>
<td></td>
<td></td>
<td><input type="checkbox" name="p6" value="32" />Cleaning of Bathrooms.<br />
</td>
</tr>
<tr>
<td></td>
<td></td>
<td></td>
<td><input type="checkbox" name="p7" value="64" />Cleaning of Outside Areas.<br />
</td>
</tr>
<tr>
...
<td align="left">
<input type="checkbox" id = "descCheck" name="p8" value="128" />Other
