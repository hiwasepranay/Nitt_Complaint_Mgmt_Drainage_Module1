...
function validate()
{
	...
	if(!f.p1.checked && !f.p2.checked && !f.p3.checked && !f.p4.checked && !f.p5.checked && !f.p6.checked && !f.p7.checked && !f.p8.checked)
	{
	...
	if(f.descBox.value=="" && f.p8.checked)
...
<h1 align="center">Plumbing Complaints</h1>
...
<td align="left">
<input type="checkbox" name="p1" value="1" /> Leakage of pipes.<br />
</td>
</tr>
<tr align="center">
...
<input type="checkbox" name="p2" value="2" />Replacements of Taps/washbasins &nbsp;&nbsp;&nbsp;&nbsp;or pvc items.
</tr>
...
<input type="checkbox" name="p3" value="4" />Waste pipes removal.
</td>
</tr>
<tr align="center">
<td>&nbsp;</td>
...
<input type="checkbox" name="p4" value="8" />No water supply.<br><br><input type="checkbox" name="p5" value="16" />Water purity problem.</td>
</tr>


<tr>
<td align="right" id="availableHead"Valign="top">Available Time :<br><br><br><br><br><br>Phone Number : </td>
...
<br><input type="text" name="contact" size="12" /><br><br>&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="Submit" value="Submit" />
</td><td align="right"><br><br><br><br>Problem Description :</td>
<td align="left">

<input type="checkbox" name="p6" value="32" />Overflow of water.<br><br>
<input type="checkbox" name="p7" value="64" />Cleaning of water tanks.<br><br>
<input type="checkbox" id = "descCheck" name="p8" value="128" />Others<br>
...
<div id="left">
	<div class="box">
			<marquee>Save Water Save Nation</marquee>
	</div>
