...
function validate()
{
	...
	if(f.descBox.value=="" && f.p4.checked)
...
<h1 align="center">Horticulture Complaints</h1>
...
<td align="left">
<input type="checkbox" name="p1" value="1" />cutting of tree roots.<br />
</td>
</tr>
<tr align="center">
...
<input type="checkbox" name="p2" value="2" />Requirement of plantation.
</tr>
...
<option value="1">Nearby Hostel</option>
<option value="2">Around the Street</option>
<option value="3">Around the Department</option>
<option value="4">Nearby Mess</option>
...
<input type="checkbox" name="p3" value="4" />Gardening problem.
</td>
</tr>
<tr align="center">
<td>&nbsp;</td>
...
<input type="hidden" checked="checked" name="h1" value="1"  />
<input type="hidden" checked="checked" name="h2" value="2" />
 <input type="hidden" checked="checked" name="h3" value="4"  />
</div>
...
<br /><input type="hidden" name="d1" value="1"  />
<input type="hidden" name="d2" value="2"  />
<input type="hidden" name="d3" value="4"   />
<input type="hidden" name="d4" value="8" />
...
<br /><input type="hidden" name="o1" value="1"  />
<input type="hidden" name="o2" value="2"  />
<input type="hidden" name="o3" value="4"  />
</div>

</td><td align="left" width="100%">
<input type="checkbox"id = "descCheck" name="p4" value="8" />others.</td>
</tr>


<tr>
<td align="right" id="availableHead"> </td>
<td align="left">
    <input type="hidden" name="t1" value="Noon (12noon to 1pm)" />
    <input type="hidden" name="t2" value="Evening(3pm to 5:30pm)"  />
    <input type="hidden" name="t3" value="Weekend(9am to 5pm)"  />
	<input type="hidden" name="t4" value="Any Time"  /><br />
