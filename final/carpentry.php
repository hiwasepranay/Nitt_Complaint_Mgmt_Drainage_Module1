...
{
	var f=document.form1
	var pr1=0,pr2=0,pr3=0,pr4=0,pr5=0
...
function validate()
{
	...
	if(!f.p1.checked && !f.p2.checked && !f.p3.checked && !f.p4.checked && !f.p5.checked && !f.p6.checked )
	{
	...
	if(f.descBox.value=="" && f.p6.checked)
...
<td align="left">
<input type="checkbox" id = "descCheck" name="p6" value="32" />Others<br>
