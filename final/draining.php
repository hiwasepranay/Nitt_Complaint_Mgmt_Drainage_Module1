...
function calcp()
{
	...
	return pr1+pr2+pr3+pr4+pr5+pr6+pr7+pr8
}
...
<h1 align="center">Drainage Complaints</h1>
...
<td align="left">
<input type="checkbox" name="p1" value="1" /> Blockage of Toilet.<br />
</td>
</tr>
<tr align="center">
...
<input type="checkbox" name="p2" value="2" />Blockage of bathroom.
</tr>
...
<input type="checkbox" name="p3" value="4" />Outside blockage/pipeline blockage.
</td>
</tr>
<tr align="center">
<td>&nbsp;</td>
...
<input type="checkbox" name="p4" value="8" />Cleaning of Garbage.<br><br><input type="checkbox" name="p5" value="16" />Cleaning of Toilets.</td>
</tr>
...
</td><td align="right"><br><br><br><br><br><br>Problem Description :</td>
<td align="left">

<input type="checkbox" name="p6" value="32" />Cleaning of Bathrooms.<br><br>
<input type="checkbox" name="p7" value="64" />Cleaning of Outside Areas.<br><br>
<input type="checkbox" name="p8" value="128" />Removal of Honeybees/Mosquitoes.<br><br>
...
<div id="left">
	<div class="box">
			<marquee>Green Nation Clean Nation</marquee>
	</div>
