...
<h1 align="center">General Complaints</h1>
<table width="95%" align="center" border="0" cellpadding="5" cellspacing="5">
<tr align="center">
<td width="39%" align="right">Enter your name : <br><br>
                              Designation :<br><br>
							  Problem Location : 
</td>
<td id="userTbox" width="25%" align="left"><input type="text" name="username" size="12" /><br><br>
									       <select name="designation" onchange="designationChange()">
										   ...
										   <select name="comlocation" onchange="show();">
...
<td id="problemHead" align="right" valign="top"><!--Problem Desc:--> </td>
<td align="left">
<textarea id = "descBox" name = "descBox" rows = "7" cols = "25" PLACEHOLDER="Enter Problem:                                        	  To:" ></textarea>
</td>
</tr>
...
<tr>
<td align="right" id="availableHead">Available Time :<br><br><br><br><br><br>Phone Number : </td>
...
<br><input type="text" name="contact" size="12" />
</td><td align="right"><!--Complaint To :--></td><td align="left">
<!--<textarea id = "descBox" name = "descBox" rows = "5" cols = "25" PLACEHOLDER="Enter the name in points....." ></textarea>-->
</td>
</tr>
