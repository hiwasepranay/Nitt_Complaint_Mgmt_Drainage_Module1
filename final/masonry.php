...
function validate()
{
	...
	if(!f.p1.checked && !f.p2.checked && !f.p3.checked && !f.p4.checked && !f.p5.checked)
	{
	...
	if(f.descBox.value=="" && f.p5.checked)
...
<h1 align="center">Masonry Complaints</h1>
...
<td align="left">
<input type="checkbox" name="p1" value="1" /> Plastering on wall.<br />
</td>
</tr>
<tr align="center">
...
<input type="checkbox" name="p2" value="2" />Fencing problem.
</tr>
...
<input type="checkbox" name="p3" value="4" />Room/Roof leakage.
</td>
</tr>
<tr align="center">
<td>&nbsp;</td>
...
<input type="checkbox" name="p4" value="8" />flooring.<br><br><input type="checkbox" name="p5" value="16" />Others.</td>
</tr>
...
<div id="left">
	<div class="box">
			<marquee>Save Nature Save Nation</marquee>
	</div>
