...
echo "<p style='margin-top: 50px; margin-left:350px;'><b>SIGNATURE OF ATTENDANT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;STORES IN - CHARGE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ASSISTANT ENGINEER</b></p>";
		...
		if(1)
		{//changes here	
			$sql="Select id,name,designation,location,description,processed,area,time,dispatchedTime,contactPerson, contactNumber, room,availablefrom,availableto,contact from complaints ";
			$status="and";
			$sql.="where ( 1=1 ";
			$status.=" processed=1";
			if ($status=="and")
...
if(isset($_POST['nm']))		
		...
		$sql="Select id,name,designation,location,description,processed,area,time,dispatchedTime, contactPerson, contactNumber, room,timing,availablefrom,availableto,contact from complaints where processed=0";
